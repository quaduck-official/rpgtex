...
{%
    background       = RPGColorFrost,
    accent           = RPGColorAmber,
    body             = RPGColorInk,
    muted            = RPGColorCharcoal,
    header           = RPGColorAubergine,
    footer           = RPGColorOxblood,
    panel-background = MyCoolColor, % You can use custom colors
    panel-accent     = RPGColorDeepTeal,
    table-row        = RPGColorOlive,
    contour          = RPGColorAsh,
}
...
{%
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        \ColorRow{RPGColorBackground}
        \ColorRow{RPGColorAccent}
        \ColorRow{RPGColorBody}
        \ColorRow{RPGColorMuted}
        \ColorRow{RPGColorHeader}
        \ColorRow{RPGColorFooter}
        \ColorRow{RPGColorPanelBackground}
        \ColorRow{RPGColorPanelAccent}
...
\RPGColorSet{header=RPGColorForest,footer=RPGColorInk,accent=MyCoolColor}%

This table starts from \texttt{default}, then changes only \texttt{header}, \texttt{footer}, and \texttt{accent} with \texttt{\char`\\RPGColorSet}.
